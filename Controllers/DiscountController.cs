...
namespace GYMFeeManagement_System_BE.Controllers
{
    ...
    public class DiscountController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] DiscountReqDTO discountDto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] DiscountReqDTO discountDto)
        {
            if (!ModelState.IsValid) return BadRequest(ModelState);
